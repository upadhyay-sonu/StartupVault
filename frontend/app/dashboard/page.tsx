        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {editMode ? (
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-white font-medium capitalize">{user.role || 'Not specified'}</p>
                </div>
                <div>
          ...
          {stats && (
            ...
            >
              ...
              <div className="card text-center">
                <div className="text-3xl font-bold text-danger mb-2">{stats.rejected}</div>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold mb-2">{claim.dealTitle}</h3>
                    ...
                    {claim.code && (
                      ...
                      >
                        ...
                        <p className="font-mono text-accent font-bold text-lg">{claim.code}</p>
                      </motion.div>
                    )}
                  </motion.div>
                ))}
